...
public class TestConfigController {
    ...
    public void testGetSensor100Config() throws Exception {
        ...
        tSensor.addParamater(new Parameter("Throttle_position", 24, 16, "Intel", 0.0015259, 0, 0, 99.9999, "%"));
        tSensor.addParamater(new Parameter("Engine_Temp", 40, 16, "Intel", 0.0030518, 50, -50.0014, 149.998, "°C"));
        tSensor.addParamater(new Parameter("RPM", 8, 16, "Intel", 1, 0, 0, 65535, "r/min"));
